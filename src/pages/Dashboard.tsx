...
const stats = [
  ...
  { label: 'AI Actions', value: '24', icon: Bot, color: 'var(--purple)' },
];
      ...
      <div className="page-content">
        ...
        <div className="dashboard-section">
          <div className="dashboard-section-header">
            ...
            <span className="text-xs type-caption">Last synced: just now</span>
          </div>
          <div className="inbox-list stagger">
            {recentActivity.map((item) => (
              <div key={`${item.channel}-${item.sender}`} className="inbox-item animate-fade-in">
